...
<main id="primary" class="site-main">
	...
	<section class="container">
		...
		<p class="text-center">We offer a number of high quality toys to help keep<br> pets healthy and spoiled!</p>
		...
		<div class="container">
			...
			<div class="row pt-5">
				<div class="categories__col col-md-4 col-sm-12 mb-3">
					<a class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden" href="#">
			...
			<div class="row mb-3">
				...
				<div class="categories__col salw col-md-8 col-sm-12 mb-3">
					<a class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden" href="#">
						<div class="position-absolute top-0 bottom-0 end-0 start-0 p-2 mb-0 bg-sale" style="z-index: 1;"></div>
						...
						<h2 class="position-absolute top-50  end-0 start-0 mb-0 text-center text-white" style="z-index: 2;">Special Offers</h2>
					</a>
				</div>
			</div>
		</div>
