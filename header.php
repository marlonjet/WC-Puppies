					...
					<div class="col-md-4">
						<ul class="annoucement-bar__list">
							<li>
								...
								<a href="telf: +34 665 23 16 06" class="text-decoration-none">+34 665 23 16 06</a>
							</li>
							<li>
								<i class="bi bi-envelope rounded-circle"></i>
								<a href="mailto:marlonlavanda@hotmail.com" class="text-decoration-none">marlonlavanda@hotmail.com</a>
							</li>
						</ul>
					</div>
					...
					<div class="row">
						<div class="col-12 d-flex justify-content-center">
							<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
								...
								<?php esc_html_e('Primary Menu', 'puppies'); ?>
							</button>
						</div>
